...
export { patchFetch as c } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
## Part 3
```js
import { d as requestAsyncStorage } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: -14
};
...
import { patchFetch as _patchFetch } from '../../server/lib/patch-fetch';
export { _patchFetch as h } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
const { requestAsyncStorage, workAsyncStorage, serverHooks } = routeModule;
export { requestAsyncStorage as d } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { workAsyncStorage as j } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
## Part 5
```js
import { f as serverHooks } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: -16
};
export { serverHooks };
...
export { serverHooks as f } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
